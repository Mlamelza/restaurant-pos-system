<?php
$pagetitle = 'Select Food Category';
...
essentially start over and select a category record from the DB.
**/
...
if( isset($_POST['thesubmit']) )
{
	...
	if(empty($formfield['ffitemcat'])){$errormsg .= "Your Category is empty! ";}
                        ...
                        <form name = "theform" id="theform" method= "post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="row g-4">
                                            <div class="col-12 pb-2">
											 <div class="form-group">
												<label for="itemcat" class ="text-light pb-2" style="font-family: 'Raleway', sans-serif;">Food Category</label>
                           ...
                           <div class="col-md-5 ps-0 d-none d-md-block">
                                <div class="form-right border border-dark border-2 rounded-3 h-100 bg-white text-dark text-center pt-2">
                                    			<img id="catlogo" alt="Category Logo" class = "pt-2" style="height: 240px; vertical-align: middle;" src="./images/catlogo2.svg">
...
{	
?>
<!--form to display if results are found....indicating no error messages--->
<div class="d-flex flex-column min-vh-100 justify-content-left align-items-left">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
...
<thead class="thead-dark border border-dark bg-dark text-light">
	<tr>
	<th scope="col" style = "font-family: 'Raleway', sans-serif;">Food Category</th>
...
<tbody class = "border border-dark">	
	...
	while ($row = $result-> fetch() )
		{
				echo '<tr><td>' . $row['dbcategoryName'] . '</td><td>' .
				//This will make a button that sends the user to another page "updatecategory.php"
				'<form action="boot_updatecategory.php" method="post">
...
//All other permissible users when logging into this page
...
//All other permissible users when a selectection has been attempted
if ((($showform == 1) || ($showform == 2) || ($showform == 3) ||
